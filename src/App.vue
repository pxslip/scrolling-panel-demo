<template>
<div class="snap-y snap-mandatory mx-auto container bg-gray-100 h-min">
  <section v-for="i in 10" :key="`scroll_section_${i}`" class="relative flex flex-row h-screen snap-start py-4 bg-gray-200 mt-4 p-4">
